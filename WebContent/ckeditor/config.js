...
CKEDITOR.editorConfig = function( config ) {
	...
	config.removeButtons = 'Save,Print,PasteFromWord,PasteText,Scayt,HiddenField,CreateDiv,Language,PageBreak,Iframe,About';
...
//	config.filebrowserImageUploadUrl = getProjectPath()+'/uploadImage';
//	config.filebrowserImageUploadUrl = '/MyBlog/src/com/zwt/controler/ImageUploadAction.java';
//	config.filebrowserImageUploadUrl = '/fileUpload/imageUpload';
	config.filebrowserImageUploadUrl = "imageUpload.action";
//	config.filebrowserUploadUrl = "actions/imageUpload";
	//工具栏是否可以收缩
//	config.toolbarCanCollapse = ture;
//	//工具栏是否默认展开
