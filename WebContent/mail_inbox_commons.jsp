	                                			...
	                                			<div class="col-md-8 col-12 m-t-10 dropdown_list_hover">
		                                            ...
		                                            <span class="dropdown">
	                                                    ...
	                                                    <span class="dropdown-menu" aria-labelledby="about-us1">
	                                                   		<a class="dropdown-item" href="#">已发送</a>
	                                                     	<a class="dropdown-item" href="#">已读文件</a>
	                                                      	<a class="dropdown-item" href="#">未读文件</a>
	                                              	...
	                                              	<span class="dropdown">
	                                                    ...
	                                                    <span class="dropdown-menu" aria-labelledby="about-us1">
	                                                    	<s:iterator value="#session.Local" id="local">
	                                                    		<a class="dropdown-item" href="receivemailcommons.action?localId=#local.id"><s:property value='#local.loaclName'/></a>
	                                                    	</s:iterator>
	                                			...
	                                			<ul class="nav nav-tabs">
		                                            <li class="nav-item active" id="primary2">
		                                                <a href="#primary" class="nav-link" data-toggle="tab"
		                                                   aria-expanded="true"><i class="fa fa-inbox"></i> 垃圾箱</a>
		                                            </li>
		                                        </ul>
